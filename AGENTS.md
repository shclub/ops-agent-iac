...
| 기본 환경 Phase 1(state·foundation·GitHub·Hermes core) 확인 | `.claude/skills/fc-deploy-verify-phase1/SKILL.md` |
| 후반 환경 Phase 2(Grafana·PagerDuty) 확인 | `.claude/skills/fc-deploy-verify-phase2/SKILL.md` |
